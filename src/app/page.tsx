      ...
      initialMessages: [
        {
          id: "0",
          role: "system",
          content: `**Welcome to KNUST IDL**

Your ultimate companion in navigating the academic landscape of Kwame Nkrumah University Of Science Technology, Intitute Of Distant Learning.`,
        },
      ],
      onResponse: () => {
        setStreaming(false);
